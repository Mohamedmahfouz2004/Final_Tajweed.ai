...
import { Plus, Edit2, Trash2, Video, BookOpen, AlertCircle, Save, X, LogOut, ShieldCheck, Layout, Users, BarChart3, UserCog, Crown, User, Mail, Calendar, Upload, ChevronDown, HelpCircle } from 'lucide-react';
        ...
        <div className="admin-root flex bg-[#F8FAFC] min-h-screen w-full" dir="rtl">
            ...
            <aside className="w-64 bg-[#0F172A] text-white flex flex-col p-6 shrink-0 shadow-2xl z-50">
                ...
                <div className="mt-auto pt-6 border-t border-gray-700">
                    ...
                    <button onClick={handleLogout} className="w-full flex items-center justify-center gap-2 bg-red-500/10 text-red-400 p-3 rounded-xl hover:bg-red-500 hover:text-white transition-all border-none font-bold cursor-pointer">
                                            ...
                                            <tr key={user._id} className="border-b border-gray-100 hover:bg-gray-50 transition-colors">
                                                ...
                                                <td className="p-4">
                                                    <div className="flex items-center justify-center gap-2">
                                                        ...
                                                        >
                                                            {user.role === 'admin' ? 'تحويل لمستخدم' : 'ترقية لمشرف ⬆'}
                                                        </button>
                                                        <button
                                            ...
                                            <div className="flex gap-6 items-center flex-1 cursor-pointer" onClick={() => setExpandedLesson(expandedLesson === (lesson._id || lesson.id) ? null : (lesson._id || lesson.id))}>
                                                ...
                                                <div>
                                                    ...
                                                    <div className="flex items-center gap-3">
                                                        ...
                                                        <span className="text-gray-400 text-sm flex items-center gap-1">
                                                            <HelpCircle size={14} /> {lesson.quizzes?.length || 0} أسئلة
                                                        </span>
                                                    </div>
                                                </div>
                                            </div>
                    ...
                    >
                        ...
                        >
                            ...
                            <form onSubmit={handleSubmit} className="p-6 flex flex-col gap-4">
                                            ...
                                            <label className="flex-1 flex items-center justify-center gap-2 p-3 bg-emerald-50 border-2 border-dashed border-emerald-300 rounded-xl cursor-pointer hover:bg-emerald-100 transition-all">
                                                ...
                                                <input type="file" accept="video/*" className="hidden" disabled={uploading}
                                                    onChange={async (e) => {
                                                        ...
                                                        try {
                                                            const res = await fetch('http://127.0.0.1:5000/api/admin/upload-video', {
                                                                method: 'POST',
                                ...
                                <button type="submit" className="mt-4 w-full py-4 bg-primary text-white rounded-xl font-bold shadow-lg hover:bg-primary-dark transition-all flex items-center justify-center gap-2 cursor-pointer border-none">
                    ...
                    >
                        ...
                        >
                            ...
                            <form onSubmit={handleQuizSubmit} className="p-6 flex flex-col gap-4">
                                ...
                                <button type="submit" className="mt-2 w-full py-4 bg-amber-500 text-white rounded-xl font-bold shadow-lg hover:bg-amber-600 transition-all flex items-center justify-center gap-2 cursor-pointer border-none">
